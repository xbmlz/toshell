...
import org.viodo.toshell.ui.components.LookAndFeelsComboBox;

/**
 * https://github.com/JFormDesigner/FlatLaf/blob/main/flatlaf-demo/src/main/java/com/formdev/flatlaf/demo/ControlBar.java
 *
 * @author Karl Tauber
 */
public class StatusBar extends JPanel {
    ...
    private void initComponents() {
        ...
        memoryProgressBar.setString("0 of 0M");
        memoryProgressBar.setToolTipText("Memory usage");
        memoryProgressBar.setPreferredSize(new Dimension(150, 22));
        memoryProgressBar.setDoubleBuffered(true);
        add(memoryProgressBar, "cell 4 1");
    }
    ...
    public static void updateMemoryProgressBar() {
        CronUtil.schedule("*/2 * * * * *", (Task) () -> {
            ...
            int usedMemory = allocatedMemory - freeMemory;

            String showText = String.format("%dM of %dM", usedMemory, maxMemory);
            String tooltipText = String.format("Max Heap Size: %dM\nAllocated: %dM\nUsed: %dM",
                    maxMemory, allocatedMemory, usedMemory);
            StatusBar.getInstance().memoryProgressBar.setMaximum(maxMemory);
            StatusBar.getInstance().memoryProgressBar.setValue(usedMemory);
            StatusBar.getInstance().memoryProgressBar.setString(showText);
            StatusBar.getInstance().memoryProgressBar.setToolTipText(tooltipText);
        });
